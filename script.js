...
class App {
    ...
    //all code that executes once the page loads
    constructor(){
        this._getPosition();
    ...
    //bind method to link this keyword when undefined
    ...
    _loadMap(position) {
            ...
            //keeps stored markers on map after leaving page
    ...
    _newWorkout(e){
        ...
        const distance = +inputDistance.value; // + will change value from string to number
        ...
        if(type === 'running'){
            ...
            !allPositives(distance, cadence, duration)
        ...
        _moveToPopup(e) {
            ...
            console.log(workout);
            // jumps from marked point to marked point on map 
...
//how to get geo location on page load
